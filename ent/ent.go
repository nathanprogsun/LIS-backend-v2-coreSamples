...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			accountsubscription.Table:      accountsubscription.ValidColumn,
			address.Table:                  address.ValidColumn,
			betaprogram.Table:              betaprogram.ValidColumn,
			betaprogramparticipation.Table: betaprogramparticipation.ValidColumn,
			clinic.Table:                   clinic.ValidColumn,
			contact.Table:                  contact.ValidColumn,
			countrylist.Table:              countrylist.ValidColumn,
			customer.Table:                 customer.ValidColumn,
			customeraddressonclinics.Table: customeraddressonclinics.ValidColumn,
			customercontactonclinics.Table: customercontactonclinics.ValidColumn,
			customersettingonclinics.Table: customersettingonclinics.ValidColumn,
			internaluser.Table:             internaluser.ValidColumn,
			labordersendhistory.Table:      labordersendhistory.ValidColumn,
			loginhistory.Table:             loginhistory.ValidColumn,
			orderflag.Table:                orderflag.ValidColumn,
			orderinfo.Table:                orderinfo.ValidColumn,
			patient.Table:                  patient.ValidColumn,
			patientflag.Table:              patientflag.ValidColumn,
			patientweightheight.Table:      patientweightheight.ValidColumn,
			pendingordercredits.Table:      pendingordercredits.ValidColumn,
			rbacactions.Table:              rbacactions.ValidColumn,
			rbacresources.Table:            rbacresources.ValidColumn,
			rbacroles.Table:                rbacroles.ValidColumn,
			salesteam.Table:                salesteam.ValidColumn,
			salesterritory.Table:           salesterritory.ValidColumn,
			salestitle.Table:               salestitle.ValidColumn,
			sample.Table:                   sample.ValidColumn,
			sampleidgenerate.Table:         sampleidgenerate.ValidColumn,
			sampletype.Table:               sampletype.ValidColumn,
			serviceship.Table:              serviceship.ValidColumn,
			serviceshipbillingplan.Table:   serviceshipbillingplan.ValidColumn,
			setting.Table:                  setting.ValidColumn,
			test.Table:                     test.ValidColumn,
			testdetail.Table:               testdetail.ValidColumn,
			testlist.Table:                 testlist.ValidColumn,
			tube.Table:                     tube.ValidColumn,
			tubeinstructions.Table:         tubeinstructions.ValidColumn,
			tubereceive.Table:              tubereceive.ValidColumn,
			tuberequirement.Table:          tuberequirement.ValidColumn,
			tubetype.Table:                 tubetype.ValidColumn,
			user.Table:                     user.ValidColumn,
			userinvitationrecord.Table:     userinvitationrecord.ValidColumn,
			zipcode.Table:                  zipcode.ValidColumn,
		})
	})
